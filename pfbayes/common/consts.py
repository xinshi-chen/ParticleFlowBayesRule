...
opts.add_argument('-ode', type=str, default='adjoint', help='ode backprop type', choices=['adjoint', 'naive'])
...
if args.ode == 'adjoint':
    from pfbayes.common.ode.cond_odeint import cond_odeint_adjoint as cond_odeint
else:  # naive
    from pfbayes.common.ode.cond_odeint import cond_odeint
